...
<head>
    ...
    <link href="{$WEB_ROOT}/templates/{$template}/assets/css/all.min.css" rel="stylesheet">
    <link href="{$WEB_ROOT}/templates/{$template}/assets/css/invoice.css" rel="stylesheet">
